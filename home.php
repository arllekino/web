            ...
            <div class="featured-posts__posts">
                <a href="./post.php" class="featured-post post_the-road-ahead">
                    ...
                    <div class="featured-post__description">
                        ...
                        <h5 class="featured-posts-description__date">September 25, 2015</h5>
                    </div>
                </a>
                <a href="" class="featured-post post_from-top-down">
            ...
            <div class="most-recent__posts">
                <a class="most-recent__post">
                    ...
                    <div class="most-recent-post__info">
                        ...
                        <h4 class="info__line">Life begins at the end of your comfort
                            zone.</h4>
                    </div>
                ...
                <a class="most-recent__post">
                    ...
                    <div class="most-recent-post__info">
                        ...
                        <h4 class="info__line">No place is ever as bad as they tell you
                            it’s going to be.</h4>
                    </div>
                    <div class="most-recent-post__description">
                        <div class="most-recent-description__autor">
                ...
                <a class="most-recent__post">
                    ...
                    <div class="most-recent-post__info">
                        ...
                        <h4 class="info__line">Travel makes you see what a tiny place
                            you occupy in the world.</h4>
                    </div>
                    <div class="most-recent-post__description">
                        <div class="most-recent-description__autor">
                            <img src="./static/image/autors/William_Wong.svg" alt=""
                ...
                <a class="most-recent__post">
                    ...
                    <div class="most-recent-post__info">
                        ...
                        <h4 class="info__line">The world is a book, and those who do not travel read only one page.
                        </h4>
                    </div>
                    <div class="most-recent-post__description">
                        <div class="most-recent-description__autor">
